...
function deleteQuickEntryRow(empId) {
  ...
  const msg = 'ล้างข้อมูลเงินเดือนของ ' + empName + ' (' + empId + ')\nเฉพาะเดือน ' + MONTHS[month-1] + ' ' + year + ' ใช่หรือไม่?\n\n⚠️ ประวัติพนักงานในฐานข้อมูลจะยังอยู่ (กลับมาใส่ข้อมูลภายหลังได้)';
  ...
  // ลบแถวออกจากตาราง (ไม่ต้องโหลดใหม่ทั้งตาราง เพราะอาจมีของเพื่อนบ้านที่ยังไม่บันทึก)
